...
function updateRankToAdvanced(username) {
    $.ajax({
        type: 'POST',
        url: 'updateRanktoAdvanced.php',
        data: { username: username },
        success: function(response) {
            console.log('Rank updated to Advanced successfully.');
            document.getElementById('rank').textContent = 'Advanced';
        },
        error: function(xhr, status, error) {
            console.error('Error updating rank to Advanced:', error);
        }
    });
}
